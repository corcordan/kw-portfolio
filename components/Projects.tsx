...
const Projects = () => {
  return (
    <div id="projects" className="bg-cream text-navy font-cormorant text-4xl relative px-16">
      ...
      <div className="absolute bottom-5 right-5">
        ...
        <div className="h-dvh flex flex-col justify-center items-center text-center space-y-8 px-32">
            <p className="font-alex text-9xl text-center pb-16">Projects</p>
            <div className="flex flex-col justify-center items-center space-y-8">
              <p className="text-7xl font-bold">Company-Wide Onboarding Program</p>
              <p>
            ...
            <div className="flex flex-col justify-center items-center space-y-8">
              <p className="text-7xl font-bold">Quarterly Performance Review System</p>
              <p>
        ...
        <div className="h-dvh flex flex-col justify-center items-center text-center space-y-8 px-32">
            <div className="flex flex-col justify-center items-center space-y-8">
              <p className="text-7xl font-bold">Culture Club & Employee Engagement Programs</p>
              <p>
            ...
            <div className="flex flex-col justify-center items-center space-y-8">
              <p className="text-7xl font-bold">Compensation & Job Structure Frmework</p>
              <p>
            ...
            <div className="flex flex-col justify-center items-center space-y-8">
              <p className="text-7xl font-bold">HR + Finance Operational Infrastructure</p>
              <p>
